...
export const SPELL_DATABASE: SpellInfo[] = [
  ...
  { name: "Scarlatum", powerMin: 0, powerMax: 200, accuracy: 80, pp: 15, cost: 1, effect: "Dano aleatório (0-200)" },
  ...
  { name: "Imperio", power: 0, accuracy: 100, pp: 3, cost: 3, isUnforgivable: true, priority: 3, debuff: { type: "taunt", chance: 100, duration: 2 }, effect: "MALDIÇÃO: bloqueia todos feitiços exceto o último (2t, IRREMOVÍVEL)" },
